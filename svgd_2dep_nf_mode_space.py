...
for i, smpl in enumerate(x0_samples.numpy()):
    ...
    y_ppc = dyn_mdl.simulate(nsteps, nsubsteps, time_step, y_init_true, smpl,
                         tau_true, K_true)
    ...
    fig.savefig(f'{figs_dir}/slp_obs_vs_pred_sample{i}.png', facecolor='white')
# %%
